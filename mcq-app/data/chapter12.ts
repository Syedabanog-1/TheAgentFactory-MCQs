  ...
  lessons: [
    {
      ...
      mcqs: [
        ...
        {
          id: 11,
          question: "You are a solo developer building a customer support chatbot. According to the Agent Maturity Model, what is the correct progression?",
          options: {
        ...
        {
          id: 12,
          question: "Your startup debates building Custom Agents vs using only General Agents. What is the strategic advantage of Custom Agents?",
          options: {
        ...
        {
          id: 13,
          question: "A fintech company needs 99% accuracy for loan approvals. Which Agent Maturity Model stage should they target?",
          options: {
        ...
        {
          id: 14,
          question: "Your manager asks why invest in Custom Agents when General Agents keep improving. What is the correct response?",
          options: {
        ...
        {
          id: 15,
          question: "Your team achieved 51% daily AI adoption. According to Stack Overflow 2025 and DORA 2025, what productivity improvement should you expect?",
          options: {
        ...
        {
          id: 30,
          question: "You are designing a Stage 2 Custom Agent for customer support tier-1. According to the Agent Maturity Model example, which combination of hard constraints and success metrics is appropriate?",
          options: {
    ...
    },
    {
      ...
      mcqs: [
        ...
        {
          id: 11,
          question: "You start a new session to continue work on an authentication feature. Claude asks 'What would you like to work on?' According to the Three Constraints, what should you do FIRST to work around the stateless constraint?",
          options: {
        ...
        {
          id: 12,
          question: "Your team is frustrated because Claude gives different implementations for the same task across sessions. According to the Three Constraints, which constraint causes this and what is the response?",
          options: {
        ...
        {
          id: 13,
          question: "Your spec + conversation + code files are approaching the context window limit. According to the Three Constraints, what is the strategic response?",
          options: {
        ...
        {
          id: 14,
          question: "A developer complains 'I re-explain our tech stack to Claude every session — wasting 15 minutes daily!' According to the Three Constraints, what solution addresses this?",
          options: {
        ...
        {
          id: 15,
          question: "A developer argues 'The Three Constraints are limitations to fight — wait for better models.' According to the course, what is the correct mindset?",
          options: {
        ...
        {
          id: 30,
          question: "A team using an AI coding agent notices it consistently generates incorrect database migration syntax despite being told the correct approach in the previous session. What is the root constraint and the correct multi-layer fix?",
          options: {
    ...
    },
    {
      ...
      mcqs: [
        ...
        {
          id: 11,
          question: "A CSV importer needs to be built. The Typist manually writes parsing, validation, error handling, and retry logic. What does the Orchestrator do differently?",
          options: {
        ...
        {
          id: 12,
          question: "You're using an AI tool that gives you code in one response without looping or reasoning. According to the OODA framework, what type of AI is this?",
          options: {
        ...
        {
          id: 13,
          question: "Your team member classifies Claude Code as a Gen 4 tool and GitHub Copilot as Gen 1. What's the key difference between these generations?",
          options: {
        ...
        {
          id: 14,
          question: "A project took 400 hrs traditionally but only 100 hrs with AI orchestration for 10 features. The manager asks 'Is the developer working less?' What's the correct response?",
          options: {
        ...
        {
          id: 15,
          question: "A developer argues 'I should only learn prompt engineering since AI does all the coding.' According to the course, what is the flaw in this reasoning?",
          options: {
        ...
        {
          id: 30,
          question: "A developer spends 3 hours manually reading error logs, tracing the bug to a configuration file, editing the config, testing, finding two remaining failures, fixing the import order, re-testing, and achieving passing tests. Which AI concept maps exactly to this workflow?",
          options: {
    ...
    },
    {
      ...
      mcqs: [
        ...
        {
          id: 11,
          question: "Your agent needs to process payments but can only view transaction metadata, not execute transfers. According to the Five Powers framework, what's the likely issue?",
          options: {
        ...
        {
          id: 12,
          question: "You're building a customer support agent. Which component provides the 'Brain' and which provides the 'Training'?",
          options: {
        ...
        {
          id: 13,
          question: "Your agent's context window is exhausted because all 50 skills load at startup with full instructions. Which concept solves this?",
          options: {
        ...
        {
          id: 14,
          question: "A team wants to build an agent that 'sees code quality issues, hears stakeholder feedback, reasons about improvements, acts to refactor, and remembers past decisions.' Which framework enables this?",
          options: {
        ...
        {
          id: 15,
          question: "A manager asks why your Development Agent costs more than a basic AI chatbot. According to the Modern AI Stack, what explains the difference?",
          options: {
    ...
    },
    {
      ...
      mcqs: [
        ...
        {
          id: 11,
          question: "Pre-Dec 2025, your team rebuilt agents from scratch when switching AI platforms. Post-AAIF, what changes?",
          options: {
        ...
        {
          id: 12,
          question: "In a monorepo, root AGENTS.md says 'use Python' but packages/backend/AGENTS.md says 'use TypeScript.' Which does the backend agent follow and why?",
          options: {
        ...
        {
          id: 13,
          question: "Loading all 50 skills at startup exhausts your context window before task execution begins. What AAIF standard solves this?",
          options: {
        ...
        {
          id: 14,
          question: "Your team debates using goose vs. Claude Code. According to AAIF standards, what is the correct positioning?",
          options: {
        ...
        {
          id: 15,
          question: "You're building a Stripe payment agent. According to AAIF standards, what components are required for full functionality?",
          options: {
        ...
        {
          id: 30,
          question: "A developer builds an AGENTS.md for a healthcare compliance AI that governs coding standards AND another AGENTS.md in the /hipaa-module subfolder with stricter security rules. When the agent works in the /hipaa-module folder, which rules apply?",
          options: {
    ...
    },
    {
      ...
      mcqs: [
        ...
        {
          id: 11,
          question: "Sarah, a financial analyst, uses AI to boost productivity 40% but only facilitates her own tasks. She's displaced by a $500/mo Digital FTE matching her $10k/mo output. What lesson does this teach?",
          options: {
        ...
        {
          id: 12,
          question: "Marcus, a healthcare compliance auditor, encodes 15 years of expertise into a Digital FTE and licenses it to hospitals. What model does this represent?",
          options: {
        ...
        {
          id: 13,
          question: "An insurance company considers a Digital FTE for claims adjudication ($1.5k/mo cost) but potential liability from 2-3 errors/month could be $200k-$300k. According to the framework, what should they do?",
          options: {
        ...
        {
          id: 14,
          question: "You're choosing a monetization model for a mission-critical SMB payroll Digital FTE. Which model is best?",
          options: {
        ...
        {
          id: 15,
          question: "You've built a successful Digital FTE on Shopify's marketplace. Months 18+, you want to pivot. According to PPP, how do you execute this?",
          options: {
    ...
    },
    {
      ...
      mcqs: [
        ...
        {
          id: 11,
          question: "A developer has good coding practices but no specifications. When they use AI, what happens according to the Amplifier Effect?",
          options: {
        ...
        {
          id: 12,
          question: "Your agent currently waits for prompts to start work. According to the FTE Threshold concept, what must change for it to become a Digital FTE?",
          options: {
        ...
        {
          id: 13,
          question: "Your team debates Path A (Vibe Coding) vs. Path B (SDD) for a production payment system. Which path and why?",
          options: {
        ...
        {
          id: 14,
          question: "Loading all agent capabilities at startup exhausts your 200K token context before task execution. Which AIDD pillar solves this?",
          options: {
            A: "Intent-Based UI",
        ...
        {
          id: 15,
          question: "Your manager asks 'Why invest in specification discipline when AI keeps getting better?' According to the Nine Pillars, what's the response?",
          options: {
        ...
        {
          id: 30,
          question: "A team is planning their first AIDD project. They want to start with Pillars 7–9 (SDD, Composable Skills, Cloud) because those seem most powerful. According to the AIDD Learning Pathway, what is wrong with this approach?",
          options: {
    ...
    },
    {
      ...
      mcqs: [
        ...
        {
          id: 11,
          question: "You're building a user registration feature. Your spec says 'make it fast and secure.' According to SDD principles, what's wrong?",
          options: {
        ...
        {
          id: 12,
          question: "Your team writes a complete spec, AI implements it, but the validation shows only 60% of success criteria are met. According to SDD, what happens next?",
          options: {
        ...
        {
          id: 13,
          question: "A developer argues 'SDD takes too long — I can just vibe code and fix issues as they come up.' For a production authentication system, what's the correct response?",
          options: {
        ...
        {
          id: 14,
          question: "During the TASKS phase, you have 8 work items estimated at 4 hours each. According to SDD guidance, what should you do?",
          options: {
        ...
        {
          id: 15,
          question: "Your spec was written upfront, but during implementation you discover a critical requirement was unknowable (a new compliance regulation). According to SDD, how should you handle this?",
          options: {
        ...
        {
          id: 30,
          question: "A developer skips the CLARIFY phase and goes directly from SPECIFY to PLAN for a payment integration feature. They wrote: 'Integrate Stripe payment.' After implementation, the team discovers 12 edge cases (partial payments, currency conversion, webhook failures, refund workflows) that were never specified. What SDD lesson does this illustrate?",
          options: {
    ...
    },
    {
      ...
      mcqs: [
        ...
        {
          id: 11,
          question: "Your team uses AI to rapidly generate 10,000 lines of code without specifications. According to the Synthesis, what is the likely outcome?",
          options: {
        ...
        {
          id: 12,
          question: "You architect a SaaS customer support Digital FTE. According to the Synthesis framework, which components are essential?",
          options: {
            A: "Only the AI model",
        ...
        {
          id: 13,
          question: "Your competitor copies your AI approach using the same tools. According to the Amplifier Effect, what creates your sustainable advantage?",
          options: {
        ...
        {
          id: 14,
          question: "A General Agent has been successfully prototyping a code review workflow for 2 weeks. According to the Digital FTE Vision, what's the next step?",
          options: {
        ...
        {
          id: 15,
          question: "Your CTO asks 'What's our Digital FTE Vision for the next 12 months?' According to the Synthesis, what should the roadmap include?",
          options: {
        ...
        {
          id: 30,
          question: "A developer says 'I don't need SDD — I'll just use AI to generate code faster and fix bugs as they appear.' According to the Digital FTE Synthesis, what compounding problem does this create over time?",
          options: {
    ...
    },
    {
      ...
      mcqs: [
        ...
        {
          id: 11,
          question: "You're selling to a hospital that needs HIPAA-compliant patient intake automation. Which value proposition and pricing model align best?",
          options: {
        ...
        {
          id: 12,
          question: "An enterprise client says 'Prove ROI for a $50k Digital FTE investment.' How do you calculate and present this?",
          options: {
        ...
        {
          id: 13,
          question: "A manufacturing company wants AI but has legacy systems (SAP, old databases). They're concerned about integration. Which of the 6 enterprise priorities does this address, and how?",
          options: {
        ...
        {
          id: 14,
          question: "You're choosing between Success Fee (10-30% commission) and Subscription ($500-$2k/mo) for a skeptical enterprise client who's never used AI. Which approach and why?",
          options: {
        ...
        {
          id: 15,
          question: "A Fortune 500 company evaluates your Digital FTE solution. According to enterprise sales best practices, what should your proposal proactively address?",
          options: {
            A: "Only the price",
    ...
    {
      id: 11,
      title: "Scenario-Based Mastery — Agent Factory Paradigm",
      mcqs: [
        { id: 1, question: "What does the $3 trillion developer economy represent in the Agent Factory paradigm?", options: { A: "The total revenue of all software companies combined", B: "The addressable market for developers building AI-native products — the economic scale making AI-native development strategically essential in 2026", C: "The amount spent globally on AI hardware", D: "The combined valuation of the top 10 AI companies" }, correct: "B", explanation: "The $3T developer economy establishes the stakes: this is not a niche experiment but the primary commercial arena for technology builders. The Agent Factory paradigm positions AI-native development as the essential competitive skill within this economy — not optional for those seeking to capture value at scale." },
        { id: 2, question: "The Agent Maturity Model in Chapter 12 serves what purpose?", options: { A: "Measuring how intelligent an AI model is", B: "A progression framework for assessing an organization's AI agent development readiness — from basic automation to full AI-native company operation", C: "Grading students on their AI knowledge", D: "Comparing different AI vendors' capabilities" }, correct: "B", explanation: "The Agent Maturity Model maps capability stages — enabling organizations to diagnose current state and plan development toward full AI-native operation. Like CMM for software, it provides a structured progression for understanding where you are and where you need to go." },
        { id: 3, question: "The Three Core Operational Constraints of LLMs define what for agent developers?", options: { A: "The minimum hardware requirements to run LLMs", B: "Technical boundaries agents must navigate: context limitations, reasoning depth, and consistency challenges — the architectural constraints that spec-driven development and context engineering are designed to work around", C: "The maximum number of agents that can run simultaneously", D: "Licensing restrictions on commercial LLM use" }, correct: "B", explanation: "Three constraints define the design space: context limitations (finite working memory requiring context engineering), reasoning depth (bounded multi-step reasoning requiring decomposition), consistency (non-deterministic outputs requiring verification). Every technique in Chapters 12-18 addresses one or more of these constraints." },
        { id: 4, question: "The Five Powers framework describes what in the AI stack?", options: { A: "Five competing AI companies and their market positions", B: "The enabling capabilities that make autonomous AI agents possible — the powers transforming language models into productive Digital Workers", C: "Five government regulations governing AI deployment", D: "Five hardware components required for AI inference" }, correct: "B", explanation: "Five Powers is the technical foundation enabling autonomous agents. Without all five — reasoning (plan), tools (act), memory (persist), orchestration (coordinate), evaluation (verify) — an agent cannot function as a Digital FTE. Chapter 12 establishes these as conceptual building blocks for Chapters 13-18." },
        { id: 5, question: "AIFF standards form the foundation for Digital FTE what?", options: { A: "Artificial Intelligence Federal Framework for government regulation", B: "Interoperability — the standards ecosystem enabling AI Workers to work across different platforms and enterprise systems without custom integration for each", C: "Audio Interface File Format for AI voice systems", D: "A specific AI company's proprietary framework" }, correct: "B", explanation: "AIFF standards solve the interoperability problem: a Digital FTE built for one enterprise context should work across tools and platforms. Standards create the infrastructure for a Digital FTE economy — portable workers that customers can hire without infrastructure lock-in." },
        { id: 6, question: "What is the Digital FTE business model's core advantage described in Chapter 12?", options: { A: "Lower upfront cost compared to hiring humans", B: "24/7 operations — Digital FTEs work continuously without overtime, vacation, or degrading quality, enabling businesses to scale output capacity without proportional headcount increases", C: "Digital FTEs require no maintenance after deployment", D: "Digital FTEs can replace all human workers immediately" }, correct: "B", explanation: "24/7 operations is the core economic advantage: a Digital FTE handling customer inquiries works continuously without fatigue. Combined with recurring revenue (subscription model), this creates fundamentally different unit economics than human labor — fixed deployment cost, variable value delivery at scale." },
        { id: 7, question: "The Nine Pillars of AIDD framework covers what?", options: { A: "Nine programming languages used in AI development", B: "Nine dimensions of AI-driven development — combining technical practices (SDD, context engineering, verification) with business practices (domain expertise, revenue models, enterprise positioning)", C: "Nine steps in the software deployment process", D: "Nine types of AI models available in 2026" }, correct: "B", explanation: "AIDD Nine Pillars integrates technical and business dimensions of professional AI-native development: Spec-Driven Development, Context Engineering, Verification, Domain Expertise, Digital FTE Architecture, Recurring Revenue Models, Enterprise Sales, AIFF Standards, and Outcome-Based Pricing." },
        { id: 8, question: "What is the $100-400 billion agentic AI market projection used to establish in Chapter 12?", options: { A: "The cost of building agentic AI systems", B: "The enterprise opportunity scale — validating that moving to agentic AI is a major commercial opportunity requiring strategic positioning now, before the market matures and differentiation collapses", C: "Government funding available for AI research", D: "The combined revenue of all AI companies in 2026" }, correct: "B", explanation: "$100-400B market establishes urgency: this is the window where early movers capture disproportionate value. Developers who build AI-native expertise now position as Enablers, Implementers, Custom Developers, or Workflow Disruptors before enterprise demand reaches full scale and commoditization sets in." },
        { id: 9, question: "What are the four value propositions for selling agentic AI services to enterprises?", options: { A: "Cost reduction, speed increase, quality improvement, scalability", B: "Enabler (training enterprises to use AI), Implementer (deploying specific solutions), Custom Developer (building bespoke Digital FTEs), and Workflow Disruptor (redesigning entire business processes)", C: "Consulting, development, deployment, maintenance", D: "SaaS, PaaS, IaaS, and on-premise" }, correct: "B", explanation: "Four go-to-market positions: Enabler (highest volume, lowest per-engagement value), Implementer (project-based), Custom Developer (bespoke high-value), Workflow Disruptor (highest value, redesigns entire functions). Each requires different domain expertise, sales motion, and pricing model." },
        { id: 10, question: "Why is domain expertise described as a competitive moat in the Digital FTE business model?", options: { A: "Domain experts can charge higher consulting rates", B: "Domain expertise encodes tacit knowledge that makes a Digital FTE valuable — a legal FTE that knows contract review patterns beats a generic agent, and that knowledge takes years to develop. Competitors cannot quickly replicate domain-specific validation criteria", C: "Domain experts have better AI programming skills", D: "Domain expertise is required by enterprise procurement regulations" }, correct: "B", explanation: "Competitive moat through domain knowledge: generic AI can be replicated instantly. An HR Digital FTE that knows industry-specific compliance requirements, terminology, and edge cases took years of domain knowledge to encode. This tacit knowledge — what Chapter 15's context engineering extracts and Chapter 16's SDD preserves — is the real differentiator." },
        { id: 11, question: "What does outcome-based pricing represent as a shift from traditional software pricing?", options: { A: "Charging per hour of computation used", B: "Moving from per-seat subscriptions (charging for access) to per-outcome results (charging for verified value delivered) — aligning vendor incentives with customer results. The Digital FTE processing 1,000 contracts is priced on contracts reviewed, not licenses held", C: "A discount pricing model for volume customers", D: "Outcome-based pricing is identical to traditional SaaS pricing" }, correct: "B", explanation: "Outcome-based pricing completes the SaaS→Agent Factory shift: SaaS charges for the right to use a tool (you do the work). Outcome-based pricing charges for the work done (the Digital FTE does the work, verified). This aligns incentives — vendor succeeds when the customer's outcome is achieved." },
        { id: 12, question: "A developer with 10 years of legal experience wants to build AI products. What positioning does Chapter 12 recommend?", options: { A: "Build a general-purpose AI assistant for lawyers", B: "Position as Custom Developer or Workflow Disruptor in the legal domain — domain expertise (contract patterns, jurisdiction nuances, compliance) is the competitive moat that generic AI cannot replicate", C: "Ignore domain expertise and focus on technical AI skills only", D: "Become an AI trainer to teach other lawyers about AI" }, correct: "B", explanation: "Domain-expert-to-Digital-FTE-builder is the high-value path: 10 years of legal knowledge is the differentiation that generic AI cannot replicate. Legal domain has clear high-value tasks (contract review, compliance), clear ROI (lawyer time is expensive), and clear enterprise buyers — Chapter 12's four value propositions place this person in Custom Developer territory immediately." },
        { id: 13, question: "What role does Spec-Driven Development play within Chapter 12's methodology framework?", options: { A: "A programming language for writing AI specifications", B: "The development methodology making Digital FTE production systematic — specifications written before code ensure the agent is built to verifiable requirements, enabling consistent quality across the 10x-100x output scale AI enables", C: "A documentation standard for software projects", D: "A testing framework for AI models" }, correct: "B", explanation: "SDD answers: how do you reliably produce high-quality Digital FTEs at scale? Vibe coding (describe and hope) fails for production. Spec-driven development (specify precisely, verify against spec, iterate from spec) separates prototype demos from commercially deployable Digital FTEs. Chapter 16 operationalizes this foundational principle established in Chapter 12." },
        { id: 14, question: "What does 2026 being a 'genuine inflection point' mean for developers according to Chapter 12?", options: { A: "All developers will be replaced by AI in 2026", B: "The point where AI-native development transitions from early-adopter advantage to competitive necessity — developers who master agentic AI in 2026 have meaningful lead time before it becomes table stakes", C: "AI becomes too complex for individual developers after 2026", D: "2026 is when AI regulation will restrict development" }, correct: "B", explanation: "Inflection point significance: in technology S-curves, the inflection point is where growth accelerates. Developers at the inflection get the steepest capability curve before broad adoption flattens differentiation. Chapter 12 frames 2026 as this moment — present now, early mainstream soon, commodity eventually. Strategic advantage requires acting at the inflection, not after." },
        { id: 15, question: "How does Chapter 12 differentiate an Agent Factory approach from generic 'AI workflow automation'?", options: { A: "There is no meaningful difference between these descriptions", B: "Workflow automation is rigid point-to-point integration. Agent Factory produces Digital FTEs with OODA reasoning, context management, spec-driven quality, and AIFF interoperability — agents that adapt, not scripts that execute. The outcome is a worker, not a workflow", C: "Agent Factory is more expensive than workflow automation", D: "Workflow automation is always better for enterprise clients" }, correct: "B", explanation: "Digital FTE vs. workflow automation: automation follows pre-defined paths; agents reason and adapt. A contract review workflow breaks when a new clause type appears. A contract review Digital FTE with domain expertise adapts by reasoning about the new clause. Chapter 12 elevates the value proposition from 'automate existing workflows' to 'deploy cognitive workers that handle novel situations.'" },
      ]
    }
  ]
};
