  ...
  lessons: [
    ...
    },
    {
      ...
      mcqs: [
        ...
        { id: 7, question: "What is Chapter 14 Quiz designed to assess?", options: { A: "Only terminal commands", B: "Comprehensive understanding of all Chapter 14: Claude Code, Skills, Subagents, MCP, Hooks, Cowork, business strategy", C: "Only business strategy", D: "Python/TypeScript coding" }, correct: "B", explanation: "Chapter 14 Quiz (Lesson 41 in Section E) covers full breadth of Chapter 14's 40+ lessons across all five sections: Section A (Claude Code Essentials), B (Skills/Subagents/MCP), C (Extensibility/Teams), D (Cowork), E (Strategy). Validates comprehensive practical understanding." },
